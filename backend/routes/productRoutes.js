...
const { createProduct, getAllProd, getSingleProd, getProdPhoto, deleteProduct, productFilter, productPagination, getRelatedProducts } = require('../controller/productController');
